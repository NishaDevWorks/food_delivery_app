      ...
      <div className="px-5 pt-8">
        ...
        {loading ? (
          ...
          <div className="mt-5 space-y-2">
            {delivered.map((o) => (
              <div key={o.id} className="bg-white rounded-2xl p-4 shadow-sm flex items-center gap-3">
                ...
                <Link
                  to="/invoice/$id"
                  params={{ id: o.id }}
                  className="px-3 h-10 rounded-xl bg-gradient-to-r from-violet-500 to-pink-500 text-white text-xs font-bold flex items-center gap-1"
                >
