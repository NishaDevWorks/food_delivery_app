    ...
    return (<div className="space-y-4">
      ...
      <div className="bg-white rounded-3xl p-5 shadow-sm">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {["preparing", "out_for_delivery", "delivered", "cancelled"].map((s) => (<div key={s} className="px-3 py-1.5 rounded-full bg-slate-100 text-xs font-semibold text-slate-700">
      ...
      <div className="bg-white rounded-3xl p-5 shadow-sm">
        ...
        {topItems.length === 0 ? (<p className="mt-3 text-xs text-slate-400">No orders yet.</p>) : (<div className="mt-3 space-y-2">
            {topItems.map((it, i) => (<div key={it.name} className="flex items-center gap-3">
